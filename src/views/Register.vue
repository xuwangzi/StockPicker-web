<template>
  <div class="register-wrapper" id="registerBackground">
    <div class="form-wrapper">
      ...
      <p class="register-system">StockPicker</p>
      <!-- 注册表单 -->
      <el-form
        class="register-form"
        ref="registerForm"
      ...
      >
        ...
        <el-form-item class="registerButtonWrapper">
          <el-button class="registerButton" type="primary" @click="goToLogin()">已有账号，去登录</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
...
export default {
  ...
  watch: {
    //  滑动解锁验证通过时，若重新输入手机号、用户名或密码，滑动解锁和登录按钮恢复原样
  ...
  methods: {
    /**
     * 跳转到登录页面
     * @description 在注册页面跳转到登录页面
     */
    goToLogin() {
      this.$message.success('请登录^_^')
